...
import { OBTENER_TAREAS_GET_ENDPOINT } from "../../connections/helpers/endpoints";
...
const DocumentosCreados = () => {
  ...
  const obtenerFormularios = async () => {
    try {
      const response = await axios.get(OBTENER_TAREAS_GET_ENDPOINT);
    ...
    <CContainer className="mt-3 mb-3">
      <CRow className="justify-content-md-center">
        <CCol sm="12" md="8" lg="6">
          <h3 className="text-center">Tareas Creadas</h3>
          <CCardBody>
            {buscando
              ? "Cargando..."
